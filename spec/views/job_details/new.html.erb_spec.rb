...
describe "job_details/new" do
  before(:each) do
    assign(:job_detail, stub_model(JobDetail,
      :job_title => "MyString",
      :category => "MyString",
      :company => "MyString",
  ...
  it "renders new job_detail form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => job_details_path, :method => "post" do
