...
describe "resume_personal_data/edit" do
  before(:each) do
  ...
  it "renders the edit resume_personal_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => resume_personal_data_path(@resume_personal_datum), :method => "post" do
