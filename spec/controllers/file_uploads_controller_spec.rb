  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested file_upload" do
        ...
        FileUpload.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => file_upload.to_param, :file_upload => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the file_upload as @file_upload" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        FileUpload.any_instance.stub(:save).and_return(false)
        put :update, {:id => file_upload.to_param, :file_upload => { "user_id" => "invalid value" }}, valid_session
        assigns(:file_upload).should eq(file_upload)
      end
