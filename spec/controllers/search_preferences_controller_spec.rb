...
describe SearchPreferencesController do
  ...
  # SearchPreference. As you add validations to SearchPreference, be sure to
  ...
  # SearchPreferencesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all search_preferences as @search_preferences" do
      search_preference = SearchPreference.create! valid_attributes
      get :index, {}, valid_session
      assigns(:search_preferences).should eq([search_preference])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested search_preference as @search_preference" do
      search_preference = SearchPreference.create! valid_attributes
      get :show, {:id => search_preference.to_param}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created search_preference" do
        post :create, {:search_preference => valid_attributes}, valid_session
        response.should redirect_to(SearchPreference.last)
      end
    end
